 ...
 * 
 */
@WebFault(name = "LoginIdentificationBadException", targetNamespace = "http://reservation.service.web.hotel/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: agence.web.service.client.reserver.LoginIdentificationBadException
     */
